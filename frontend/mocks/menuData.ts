...
export const mockMenus: Menu[] = [
  {
    ...
    engName: "Americano",
    description:
      "진한 에스프레소와 물의 완벽한 조화. 깔끔하고 깊은 맛을 느낄 수 있습니다.",
    price: 4500,
    ...
    options: [
      ...
      },
      {
        ...
        type: "checkbox",
        required: false,
        items: [{ id: "extra-shot", name: "샷 추가", priceDelta: 500 }],
      },
    ],
  ...
  },
  {
    ...
    engName: "Cafe Latte",
    description:
      "부드러운 우유와 에스프레소의 조화. 고소하고 부드러운 맛이 특징입니다.",
    price: 5000,
    category: mockCategories[0],
    images: [
      {
        id: "2-1",
        url: "https://images.unsplash.com/photo-1561882468-4853373ea92f?q=80&w=800&auto=format&fit=crop",
        isPrimary: true,
        sortOrder: 0,
      },
    ],
  ...
  },
  {
    ...
    engName: "Cappuccino",
    description:
      "풍성한 우유 거품과 에스프레소의 조화. 부드럽고 크리미한 맛을 즐기세요.",
    price: 5500,
    category: mockCategories[0],
    images: [
      {
        id: "3-1",
        url: "https://images.unsplash.com/photo-1572442388796-11668a67e53d?q=80&w=800&auto=format&fit=crop",
        isPrimary: true,
        sortOrder: 0,
      },
    ],
  ...
  },
  {
    ...
    images: [
      {
        id: "4-1",
        url: "https://images.unsplash.com/photo-1570968992193-96ab70c6524b?q=80&w=800&auto=format&fit=crop",
        isPrimary: true,
        sortOrder: 0,
      },
    ],
  ...
  },
  {
    ...
    images: [
      {
        id: "5-1",
        url: "https://images.unsplash.com/photo-1485808191679-5f8c7c8606af?q=80&w=800&auto=format&fit=crop",
        isPrimary: true,
        sortOrder: 0,
      },
    ],
  ...
  },
  {
    ...
    images: [
      {
        id: "6-1",
        url: "https://images.unsplash.com/photo-1638176066666-ffb2f013c7dd?q=80&w=800&auto=format&fit=crop",
        isPrimary: true,
        sortOrder: 0,
      },
    ],
  ...
  },
  {
    ...
    images: [
      {
        id: "8-1",
        url: "https://images.unsplash.com/photo-1594631252845-29fc4cc8cde9?q=80&w=800&auto=format&fit=crop",
        isPrimary: true,
        sortOrder: 0,
      },
    ],
  ...
  },
  {
    ...
    engName: "Tiramisu",
    description:
      "에스프레소에 적신 스펀지와 마스카포네 크림의 이탈리안 디저트.",
    price: 7000,
  ...
  },
  {
    ...
    images: [
      {
        id: "10-1",
        url: "https://images.unsplash.com/photo-1555507036-ab1f40388085?q=80&w=800&auto=format&fit=crop",
        isPrimary: true,
        sortOrder: 0,
      },
    ],
